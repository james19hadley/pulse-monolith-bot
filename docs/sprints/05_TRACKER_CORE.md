...
## 📋 Tasks
- [x] Add `/projects` command to list all active projects with their IDs and current total time.
- [x] Upgrade `/new_project` to have proper edge-case handling and integrate its response into `views.py`.
- [x] Update `cmd_end_session` logic:
...
## 🏁 Completion Criteria
- User can start a session, log 30 minutes, wait 60 minutes, end the session, and see a summary stating they had 30 mins of Focus and 30 mins of The Void. (ACHIEVED)
