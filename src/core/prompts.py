...
- EDIT_ENTITIES: The user wants to delete, rename or modify properties of an existing project or habit (e.g. "Rename 'Coding' to 'Backend Dev'", "Change the habit target to 20 reps").
