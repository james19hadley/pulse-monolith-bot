...
def get_persona_prompt(persona_type: str, custom_prompt: str = None, report_config: dict = None, talkativeness_level: str = "standard") -> str:
    ...
    # 1.5 Talkativeness
    talk_context = ""
    if talkativeness_level == "minimal":
        talk_context = "\nTALKATIVENESS LIMITER: You are set to MINIMAL talkativeness. Provide ONLY facts, numbers, and direct confirmations. No empathy, no fluff, no extra sentences."
